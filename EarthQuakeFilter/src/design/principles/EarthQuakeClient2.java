...
//        }
        ...
        ArrayList<QuakeEntry> quakeEntries = filter(list, f);
        Filter f2 = new DepthFilter(-55000.0, -20000.0);

//        Location location = new Location(39.7392, -104.9903);
//        Filter f3 = new DistanceFilter(location, 1000000);
//        ArrayList<QuakeEntry> quakeEntries = filter(list, f3);
//
//        Filter f1 = new PhraseFilter("end", "a");
        ArrayList<QuakeEntry> result = filter(quakeEntries, f2);
